...
Not for creating or managing monitors. The only public endpoint is the
[heartbeat ping](/docs/heartbeat-api). Outbound webhooks are the integration surface.

A management API is on the [roadmap](/roadmap).
